        	...
        	<table class="table table-striped">
        		...
        		<tbody>
        			...
        			<tr>
        				...
        				<td><?php if($actifs[$key]['group'] == 'admin') : ?>Admin<?php else : ?><a href="deauthorize_admin.php?id=<?php echo $actifs[$key]['id']; ?>" class="btn btn-danger">Desautoriser</a><?php endif; ?></td>
        			</tr>
        			<?php endforeach; ?>
        		</tbody>
        	</table>
